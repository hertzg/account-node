...
module.exports = (username, password, profile, registerTime,
    ...
    return {
        ...
        editProfile: (newProfile, token) => {
            ...
            if (fullNamePrivacy !== 'private') {
                if (contactsProfile.fullName !== fullName) {
                    contactsProfile.fullName = fullName
                    contactsProfileChanged = true
                }
                if (fullNamePrivacy !== 'contacts') {
                    if (publicProfile.fullName !== fullName) {
                        publicProfile.fullName = fullName
            ...
            if (emailPrivacy !== 'private') {
                if (contactsProfile.email !== email) {
                    contactsProfile.email = email
                    contactsProfileChanged = true
                }
                if (emailPrivacy !== 'contacts') {
                    if (publicProfile.email !== email) {
            ...
            if (phonePrivacy !== 'private') {
                if (contactsProfile.phone !== phone) {
                    contactsProfile.phone = phone
                    contactsProfileChanged = true
                }
                if (phonePrivacy !== 'contacts') {
                    if (publicProfile.phone !== phone) {
