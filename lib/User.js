...
module.exports = (username, password, profile, registerTime,
    ...
    return {
        ...
        receiveFileMessage: (contactUsername, name, size, time, token) => {
            castSessionMessage(['receiveFileMessage', [contactUsername, name, size, time]], token)
        },
        receiveTextMessage: (contactUsername, text, time, token) => {
            castSessionMessage(['receiveTextMessage', [contactUsername, text, time]], token)
        },
        ...
        sendFileMessage: (contactUsername, name, size, time, token) => {
            castSessionMessage(['sendFileMessage', [contactUsername, name, size, time]], token)
            SendFileMessage(username, contactUsername, name, size, time)
        },
        sendTextMessage: (contactUsername, text, time, token) => {
            castSessionMessage(['sendTextMessage', [contactUsername, text, time]], token)
            SendTextMessage(username, contactUsername, text, time)
        },
        toStorageObject: () => {
            return {
                password: {
