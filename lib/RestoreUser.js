...
module.exports = storageObject => {
    ...
    var user = User(password, storageObject.fullName, storageObject.email,
        storageObject.phone, storageObject.registerTime,
        sessions, PlainObject(storageObject.contacts))
