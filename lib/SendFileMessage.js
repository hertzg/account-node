...
var logPrefix = 'account-node-client: ' + host + ':' + port + ': accountNode/receiveFileMessage: '

module.exports = (username, contactUsername, name, size, time) => {
    ...
    var proxyReq = http.request({
        ...
        path: '/accountNode/receiveFileMessage' +
            ...
            '&size=' + encodeURIComponent(size) + '&time=' + time,
    }, proxyRes => {
