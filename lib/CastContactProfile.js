...
module.exports = (contacts, username, profile) => {
    ...
    var logPrefix = 'account-node-client: ' + host + ':' + port + ': contactProfile: '

    var proxyReq = http.request({
        host: host,
        port: port,
        path: '/contactProfile?username=' + encodeURIComponent(username) +
