...
module.exports = users => {
    return (req, res, parsedUrl) => {
        ...
        ;(() => {
            ...
            var logPrefix = 'captcha-node-client: ' + host + ':' + port + ' verify: '
            ...
            var proxyReq = http.request({
                ...
                proxyRes.on('end', () => {
                    ...
                    var user = User(username, {
                        ...
                        email: '',
                        phone: '',
                    }, Date.now(), Object.create(null), Object.create(null), Object.create(null), Object.create(null), Object.create(null))
                    users[username] = user

                    Log.info('"' + username + '" signed up')
                    OpenSession(username, user, res, true)
